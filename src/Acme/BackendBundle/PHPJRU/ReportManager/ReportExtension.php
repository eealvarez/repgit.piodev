 ...
 * */ 
require_once ('ReportExtensionInterface.php');

 /**
 * Esta clase permite definir una extension para reportes
 * */
abstract class ReportExtension implements ReportExtensionInterface
{
        
        public $container;
        
	/**
	 * @var $reportFileName nombre del archivo  sin la extension
	 * */
	...
	public $alias;
	/***
	 * @var boolean $enabled indica si esta  habilitado
	 */
	public $enabled = true;			
